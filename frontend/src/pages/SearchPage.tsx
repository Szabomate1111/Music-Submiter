...
/*  */
  ...
  const getSubmitButtonText = (trackId: string): string => {
    ...
    switch (status) {
      case 'submitting': return 'Beküldés...';
      case 'success': return 'Beküldve!';
      case 'error': return 'Hiba - Próbáld újra';
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-4xl relative z-10 flex flex-col items-center">
        <div className="text-center mb-8 sm:mb-12 mt-12 sm:mt-20 animate-fade-in">
          ...
          <p className="text-white/90 text-lg sm:text-xl drop-shadow-lg font-medium px-4">Zeneszám keresés és beküldés</p>
          ...
          <div className="mb-8 sm:mb-12 w-full max-w-2xl px-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <input
                ...
                placeholder="Keress zeneszámokat... (min. 3 karakter)"
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    <span className="hidden text-xs sm:text-sm font-medium">Keresés</span>
                  </>
                )}
              </button>
            </div>
              ...
              >
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <button
                    ...
                    title={`Beküldés: ${track.title} - ${track.artist}`}
                  >
                    Beküldés
                  </button>
                  <button
